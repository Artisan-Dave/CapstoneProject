                ...
                for (DataSnapshot collectorSnapshot : snapshot.getChildren()) {
                    if (collectorSnapshot.child("mobile_number").exists()) {
                        ...
                        if (mobileNumber != null) {
                            String message = "Please check for oversize items or initiate manual collection";
...
//                sendSmsToCollectors();
    ...
    public void makeNotification() {
        ...
        builder.setSmallIcon(R.drawable.baseline_notifications_active_24)
                ...
                .setContentText("Please check for oversize items or initiate manual collection")
                .setAutoCancel(true)
    ...
    private void cancelNotification() {
        // Cancel the notification when the button is pressed
