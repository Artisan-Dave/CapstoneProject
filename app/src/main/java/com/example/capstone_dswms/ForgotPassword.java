                    ...
                    databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.child("users").hasChild(phonetxt)) {
                                CustomToast.showCustomToast(ForgotPassword.this, "Number registered!");
                                ...
                                CustomToast.showCustomToast(ForgotPassword.this, "Change Password Successful");
                                ...
                                CustomToast.showCustomToast(ForgotPassword.this, "Number registered as admin!");
                                ...
                                CustomToast.showCustomToast(ForgotPassword.this, "Password changed successfully!");
                                //Toast.makeText(ForgotPassword.this, "Password changed successfully", Toast.LENGTH_SHORT).show();
                                // Clear the stored username from SharedPreferences
                                SharedPreferences.Editor editor = sharedPreferences.edit();
                                editor.remove("KEY_USERNAME");
