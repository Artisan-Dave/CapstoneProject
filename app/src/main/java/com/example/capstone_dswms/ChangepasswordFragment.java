...
//        return inflater.inflate(R.layout.fragment_changepass, container, false);
        ...
        // Update the toolbar title when the fragment is created or becomes active
        if (getActivity() != null && getActivity() instanceof MainActivity) {
            ((MainActivity) getActivity()).updateToolbarTitle("Change Password");
        }
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.exists()) {
                                ...
                                if (storedOldPassword.equals(oldPassword)) {
                                    ...
                                    CustomToast.showCustomToast(getActivity(), "Change Password Successful");
                                } else {
